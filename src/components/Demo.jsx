  ...
  return (
    <section className = "mt-16 w-full max-w-xl">
      ...
      <div className = "flex flex-col w-full gap-2">
        ...
        <p className = "flex-1 front-satoshi text-blue-700 font-medium text -sm truncate">
          {item.url}
         </p>
      </div>
    ))}
        ...
        {isFetching?(
          ...
          article.summary&&(
            ...
            <div className="summary_box">
              <p className="front-inter font-medium text-sm text-gray-700">{article.summary}</p>
            </div>
          </div>
          )
        )}
